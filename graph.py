...
def plot_all_measures_vs_random_from_csv(
    ...
    cent_rus = ['промежуточность', 'близость', 'степень', 'влиятельность', 'гармоническая', 'перколяционная', 'случайный']
    ...
    for idx, measure in enumerate(available_measures):
        ...
        ax.set_title(f"{cent_rus[idx]} против случайной \n {measure} vs random, $p_{{within}}={p_within_val}$", fontsize=16)
        ax.set_zlim(0, max_rate)
...
cent_map = {
    "betweenness":  "промежуточность",
    "closeness":    "близость",
    "degree":       "степень",
    "random":       "случайный",
    "eigenvector":  "влиятельность",
    "harmonic":     "гармоническая",
    "percolation":  "перколяционная",
}
